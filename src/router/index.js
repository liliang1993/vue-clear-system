...
const router = new VueRouter({
  ...
  routes: [{ //前台路由配置
    ...
    children: [{
      ...
      path: 'bridgeRecords',
      component: require('../pages/bridgeRecords')
    }, {
      path: 'article/:type',
    ...
    children: [{
      path: '/',
      component: require('../admin/welcome')
    }, {
      path: 'welcome',
      component: require('../admin/welcome')
    }, {
      path: 'article/:type',
      component: require('../admin/article')
    }, {
      path: 'article/:type/edit/:id',
      component: require('../admin/editArticle')
    }, {
      path: 'setting/:type',
      component: require('../admin/setting')
    }]
  }, ]
})
